      ...
      <div className="container mx-auto px-4">
        <header className="text-center mb-12">
          <h1
            ...
            itemProp="name"
          >
            🚨 Аварийный Комиссар 24/7 в Воронеже, Липецке, Курске - Независимая
            Автоэкспертиза
          </h1>
          <div
          ...
          >
            <p className="font-bold text-amber-400 mb-2">
              ⚡ Срочный вызов аварийного комиссара в городах:{" "}
              {targetRegions.map((r) => r.name).join(", ")}
            </p>
            <p>
              <strong>
                🛡️ Профессиональная служба помощи водителям после ДТП:
              </strong>{" "}
              вызов аварийного комиссара за 15 минут, независимая автоэкспертиза
              с максимальными страховыми выплатами по ОСАГО/КАСКО, судебная
              экспертиза автомобилей, оценка ущерба и УТС
            </p>
          </div>
        ...
        <div className="text-center mt-12 bg-slate-900 p-8 rounded-xl">
          <h2 className="text-2xl font-bold text-white mb-4">
            🆘 СРОЧНО Вызвать Аварийного Комиссара - Приезжаем за 15 минут!
          </h2>
          <p className="text-slate-300 text-lg mb-4 max-w-3xl mx-auto">
            <strong className="text-amber-400">
              ⏱️ Круглосуточно работаем во всех городах: Воронеж, Липецк, Курск,
              Брянск, Ростов-на-Дону, Краснодар, Саратов
            </strong>
          </p>
