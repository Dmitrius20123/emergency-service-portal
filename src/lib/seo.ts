...
export const defaultSEO: SEOConfig = {
  ...
  description:
    "Федеральная служба аварийных комиссаров, оформление ДТП, юридическая помощь, эвакуация автомобиля, независимая экспертиза. Работаем в 7 городах: Воронеж, Липецк, Курск, Брянск, Ростов-на-Дону, Краснодар, Саратов. Приезжаем за 15 минут. ☎️ +7 (951) 853-82-42",
