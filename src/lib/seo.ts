...
export const generatePageSEO = (page: string): SEOConfig => {
  ...
  switch (page) {
    ...
    case "reviews":
      return {
        ...baseSEO,
        title: "Отзывы клиентов - Аварийный Комиссар 24/7 | Независимая Автоэкспертиза",
        description: "Читайте реальные отзывы наших клиентов об услугах аварийного комиссара и независимой автоэкспертизы. Более 500 довольных клиентов в 10 городах России.",
      };
    default:
      return baseSEO;
  }
