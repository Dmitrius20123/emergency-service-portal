...
export const defaultSEO: SEOConfig = {
  title:
    "Вызвать Аварийного Комиссара 24/7 | Независимая Автоэкспертиза | Единый Центр Помощи после ДТП | +7 (951) 853-82-42",
  description:
    "⚡ СРОЧНО вызвать аварийного комиссара! Единый Центр Помощи после ДТП работает в Воронеже, Липецке, Курске, Брянске, Ростове-на-Дону, Краснодаре, Саратове. Независимая автоэкспертиза, максимальные выплаты ОСАГО/КАСКО. Приезжаем за 15 минут! ☎️ +7 (951) 853-82-42",
